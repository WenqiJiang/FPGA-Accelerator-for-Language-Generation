...
# RNN layer
python h5_to_txt.py --iname="./simple_rnn_3_bias.h5" --dataset="/simple_rnn_3/bias:0" --dim_num=1 --length1=128 > simple_rnn_1_bias.txt
				# h5dump -d "/simple_rnn_1/bias:0" simple_rnn_1_bias.h5
python h5_to_txt.py --iname="./simple_rnn_3_kernel.h5" --dataset="/simple_rnn_3/kernel:0" --dim_num=2 --length1=100 --length2=128 > simple_rnn_1_kernel.txt
				# h5dump -d "/simple_rnn_1/kernel:0" simple_rnn_1_kernel.h5
python h5_to_txt.py --iname="./simple_rnn_3_recurrent_kernel.h5" --dataset="/simple_rnn_3/recurrent_kernel:0" --dim_num=2 --length1=128 --length2=128 > simple_rnn_1_recurrent_kernel.txt
...
python h5_to_txt.py --iname="./dense_3_bias.h5" \
				...
				--dim_num=1 --length1=6144 > dense_1_bias.txt
