...
// #pragma SDS data zero_copy(last_state[0: (BATCH_SIZE * RNN_STATE_SIZE)])
// #pragma SDS data zero_copy(input_state[0: (BATCH_SIZE * RNN_INPUT_SIZE)])
...
// #pragma SDS data zero_copy(output_state[0: (BATCH_SIZE * RNN_STATE_SIZE)])
