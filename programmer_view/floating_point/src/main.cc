...
int main(int argc, char *argv[]) {
  ...
  for (LDATA_T compute_time = 0; compute_time < COMPUTE_TIME / 2;
    ...
    wrapper_rnn_fc(
        ...
        rnn_bias, fc_kernel_transpose, fc_bias,
        /* input_word_idx = */result_idx_one_step0, rnn_input_state_cache,
        /* rnn_last_state = */rnn_state0, /* rnn_output_state = */rnn_state1,
    ...
    wrapper_rnn_fc(
        word_embedding, rnn_kernel_transpose, rnn_recurrent_kernel_transpose,
        rnn_bias, fc_kernel_transpose, fc_bias,
        /* input_word_idx = */result_idx_one_step1, rnn_input_state_cache,
        /* rnn_last_state = */rnn_state1, /* rnn_output_state = */rnn_state0,
